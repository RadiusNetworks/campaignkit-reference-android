...
public class DetailActivity extends FragmentActivity {
    ...
    /**
     * Called when the activity has been opened when it was already running. In
     * this case, this usually occurs when the user tapped on an alert created
     * by CampaignNotificationBuilder.
     */
    @Override
    public void onNewIntent(Intent intent) {
        Log.i(TAG, "onNewIntent.");
        if (intent != null && intent.getExtras() != null
                && intent.getExtras().getString(KEY_CAMPAIGN_ID, "") != "") {
            Log.i(TAG,
                    "onNewIntent. campaignId = "
                            + intent.getExtras().getString(KEY_CAMPAIGN_ID, ""));
