...
public class SlidingTabsBasicFragment extends Fragment {
    ...
    class SamplePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = getActivity().getLayoutInflater().inflate(R.layout.pager_item, container,
                    false);
            ...
            if (_campaignArray.get(position) != null) {
                ...
                contentView.loadData(_campaignArray.get(position).getBody(), "text/html", null);

            } else
                Log.e("instantiateItem", "campaign at position " + position + " = null");
            // Return the View
            return view;
        }
