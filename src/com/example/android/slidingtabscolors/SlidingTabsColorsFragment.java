...
public class SlidingTabsColorsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for (Campaign c : mCampaignArray) {
            mTabs.add(new SamplePagerItem(c.getTitle(), // Title
                    c.getBody(), // HTML Content
                    Color.parseColor(getResources().getString(R.color.radius_blue)), // Indicator
                                                                                     // color
                    Color.parseColor(getResources().getString(R.color.radius_light_grey)) // Divider
                                                                                          // color
            ));
        }
    ...
    class SampleFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int i) {
            ...
            if (mActivity != null && mCampaignArray != null && mCampaignArray.get(i) != null)
                ((MyApplication) mActivity.getApplication()).recordAnalytics(
                        CampaignKitNotifier.CKAnalyticsType.viewed, mCampaignArray.get(i));
            else
                Log.i("SlidingTabsColorsFragment",
                        "SampleFragmentPagerAdapter.what's null? mActivity=" + mActivity
                                + ". mCampaignArray=" + mCampaignArray);
        ...
        public void setPrimaryItem(ViewGroup container, int position, Object object) {
            Log.i("SlidingTabsColorsFragment",
                    "SampleFragmentPagerAdapter.setPrimaryItem position = " + position);
